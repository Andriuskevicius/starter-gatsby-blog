    ...
    <nav role="navigation" className={styles.container} aria-label="Main">
      ...
      <ul className={styles.navigation}>
        <li className={styles.navigationItem}>
          <div onClick={props.handleClick} className={styles.burger}>
            <span>Viskas</span>
            {burger}
          </div>
        </li>
        <li className={styles.navigationItem}>
          <Link to="/category/robotics/" activeClassName="active">
            Robotika
          </Link>
        </li>
        <li className={styles.navigationItem}>
          <Link to="/category/crypto/" activeClassName="active">
            Kripto
          </Link>
        </li>
        <li className={styles.navigationItem}>
          <Link to="/category/ai/" activeClassName="active">
            AI
          </Link>
        </li>
        <li className={styles.navigationItem}>
          <Link to="/category/apps/" activeClassName="active">
            Apps
          </Link>
        </li>
        <li className={styles.navigationItem}>
          <Link to="/category/startups/" activeClassName="active">
            Startuoliai
          </Link>
        </li>
      </ul>
